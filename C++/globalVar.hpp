...
char IP_table[65] = {0, 58, 50, 42, 34, 26, 18, 10, 2,  60, 52, 44, 36,
...
char IP_inverse_table[65] = {0, 40, 8,  48, 16, 56, 24, 64, 32, 39, 7,  47, 15,
...
char E_table[49] = {0,  32, 1,  2,  3,  4,  5,
                    4,  5,  6,  7,  8,  9,  8,
                    9,  10, 11, 12, 13, 12, 13,
...
char P_table[33] = {0,  16, 7, 20, 21, 29, 12, 28, 17, 1,  15,
                    23, 26, 5, 18, 31, 10, 2,  8,  24, 14, 32,
                    27, 3,  9, 19, 13, 30, 6,  22, 11, 4,  25
};

char PC_1_table[57] = {0,  57, 49, 41, 33, 25, 17, 9,  1,  58, 50, 42, 34, 26, 18,
                       10, 2,  59, 51, 43, 35, 27, 19, 11, 3,  60, 52, 44, 36, 63,
                       55, 47, 39, 31, 23, 15, 7,  62, 54, 46, 38, 30, 22, 14, 6,
                       61, 53, 45, 37, 29, 21, 13, 5,  28, 20, 12, 4
};

char PC_2_table[49] = {0,  14, 17, 11, 24, 1,  5,  3,  28, 15, 6,  21, 10,
